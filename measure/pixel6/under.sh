...
while true; do
    ...
    COOL_REQ_CPU_BIG=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-2/user_vote 2>/dev/null)
    COOL_REQ_CPU_MID=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-1/user_vote 2>/dev/null)
    COOL_REQ_CPU_LITTLE=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-0/user_vote 2>/dev/null)
    COOL_REQ_GPU=$(cat /dev/thermal/cdev-by-name/thermal-gpufreq-0/user_vote 2>/dev/null)
    COOL_CUR_CPU_BIG=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-2/cur_state 2>/dev/null)
    COOL_CUR_CPU_MID=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-1/cur_state 2>/dev/null)
    COOL_CUR_CPU_LITTLE=$(cat /dev/thermal/cdev-by-name/thermal-cpufreq-0/cur_state 2>/dev/null)
    COOL_CUR_GPU=$(cat /dev/thermal/cdev-by-name/thermal-gpufreq-0/cur_state 2>/dev/null)
