...
log_path = "/home/serae/Desktop/MoTher/measure/pixel5/T5/log.txt" 
...
columns = [
    ...
    "min_freq0", "min_freq1", "min_freq2", "min_freq3", "min_freq4", "min_freq5", "min_freq6", "min_freq7", "min_freq_gpu",
    "max_freq0", "max_freq1", "max_freq2", "max_freq3", "max_freq4", "max_freq5", "max_freq6", "max_freq7", "max_freq_gpu",
    ...
    "util_cpu0","util_cpu1","util_cpu2","util_cpu3","util_cpu4","util_cpu5","util_cpu6","util_cpu7","util_gpu","power"
] 
...
for i in range(8):
    df[f"freq{i}"] /= 1000000
    df[f"min_freq{i}"] /= 1000000
    df[f"max_freq{i}"] /= 1000000
df["freq_gpu"] /= 1000000
df["min_freq_gpu"] /= 1000000
df["max_freq_gpu"] /= 1000000
...
#######################
#ax2.plot(df["time"].values, df["min_freq7"].values, label="CPU_BIG Freq (MHz)", color="blue", alpha=1, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq6"].values, label="CPU_MID Freq (MHz)", color="orange", alpha=0.8, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq0"].values, label="CPU_LITTLE0 Freq (MHz)", color="red", alpha=0.6, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq1"].values, label="CPU_LITTLE1 Freq (MHz)", color="red", alpha=0.4, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq2"].values, label="CPU_LITTLE2 Freq (MHz)", color="red", alpha=1, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq3"].values, label="CPU_LITTLE3 Freq (MHz)", color="red", alpha=0.8, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq4"].values, label="CPU_LITTLE4 Freq (MHz)", color="red", alpha=0.6, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq5"].values, label="CPU_LITTLE5 Freq (MHz)", color="red", alpha=0.4, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["min_freq_gpu"].values, label="GPU Freq (MHz)", color="green", alpha=1, linestyle="--", zorder=1)

#ax2.plot(df["time"].values, df["max_freq7"].values, label="CPU_BIG Freq (MHz)", color="blue", alpha=1, linestyle="--", zorder=10)
#ax2.plot(df["time"].values, df["max_freq6"].values, label="CPU_MID Freq (MHz)", color="orange", alpha=0.8, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq0"].values, label="CPU_LITTLE0 Freq (MHz)", color="red", alpha=0.6, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq1"].values, label="CPU_LITTLE1 Freq (MHz)", color="red", alpha=0.4, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq2"].values, label="CPU_LITTLE2 Freq (MHz)", color="red", alpha=1, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq3"].values, label="CPU_LITTLE3 Freq (MHz)", color="red", alpha=0.8, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq4"].values, label="CPU_LITTLE4 Freq (MHz)", color="red", alpha=0.6, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq5"].values, label="CPU_LITTLE5 Freq (MHz)", color="red", alpha=0.4, linestyle="--", zorder=1)
#ax2.plot(df["time"].values, df["max_freq_gpu"].values, label="GPU Freq (MHz)", color="green", alpha=1, linestyle="--", zorder=1)
#######################
...
ax1 = ax2.twinx()
#ax1.plot(df["time"].values, df["temp_cpu_bigmid_tot"].values, label="BIGMID Temp (°C)", color="blue", zorder=100)
#ax1.plot(df["time"].values, df["temp_cpu_little_tot"].values, label="LITTLE Temp (°C)", color="red", zorder=100)
...
#ax1.plot(df["time"].values, df["util_cpu0"].values, label="LITTLE0 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu1"].values, label="LITTLE1 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu2"].values, label="LITTLE2 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu3"].values, label="LITTLE3 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu4"].values, label="LITTLE4 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu5"].values, label="LITTLE5 UTIL(%)", color="gray", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu6"].values, label="MID UTIL(%)", color="black", zorder=10)
#ax1.plot(df["time"].values, df["util_cpu7"].values, label="BIG UTIL(%)", color="skyblue", zorder=10)
#ax1.plot(df["time"].values, df["util_gpu"].values, label="GPU UTIL(%)", color="black", zorder=10)
#ax2.plot(df["time"].values, df["power"].values, label="TOTAL_POWER", color="purple", alpha=1, linewidth=3)
